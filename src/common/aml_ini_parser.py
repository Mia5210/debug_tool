...
class AmlParserIniManager:
    ...
    AML_PARSER_SECTION_SOURCE        = "AM_SOURCE"
    ...
    AML_INI_SECTION_DIC = {
        ...
        AmlCommonUtils.AML_DEBUG_MODULE_SOURCE: AML_PARSER_SECTION_SOURCE,
        AmlCommonUtils.AML_DEBUG_MODULE_SYS_OPERATION: AML_PARSER_SECTION_SYS_OPERATION,
    }

    def __init__(self):
        self.__parser = configparser.ConfigParser() #create configparser
